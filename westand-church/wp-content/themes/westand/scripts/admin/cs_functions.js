  ...
  $("#"+id).slideUp(800);
	...
	function new_toggle_inside_post(id){
		...
		var counter_ingredient = 0;
                                        jQuery(document).on("click", "a.add_accordion", function () {
						...
						return false;
                                        ...
                                        jQuery(document).on("click", "a.addedtab", function () {
						var mainConitem=jQuery(this) .parents(".wrapptabbox");
						var appendtoItem=mainConitem.find(".clone_append") ;
						var newElement =jQuery("<div class='clone_form'> \
								<a href='#' class='deleteit_node'>Delete it</a> \
					...
					// services start
                                        jQuery(document).on("click", "a.add_services", function () {
						var mainConitem=jQuery(this) .parents(".wrapptabbox");
						var appendtoItem=mainConitem.find(".clone_append") ;
						var newElement =jQuery("<div class='clone_form'> \
								<a href='#' class='deleteit_node'>Delete it</a> \
								...
								<label>Service Fontawsome Icon:</label> <input class='txtfield' type='text' name='service_icon[]' /> <p>You can get fontawsome icons from fontawsome website</p> \
					...
					// testimonial start
                                        jQuery(document).on("click", "a.added_testimonial", function () {
						var mainConitem=jQuery(this) .parents(".wrapptabbox");
						var appendtoItem=mainConitem.find(".clone_append") ;
						var newElement =jQuery("<div class='clone_form'> \
								<a href='#' class='deleteit_node'>Delete it</a> \
					...
					// team start
                                        jQuery(document).on("click", "a.added_team", function () {
						var mainConitem=jQuery(this) .parents(".wrapptabbox");
						var appendtoItem=mainConitem.find(".clone_append") ;
						var newElement =jQuery("<div class='clone_form'> \
								<a href='#' class='deleteit_node'>Delete it</a> \
...
var count_widget = jQuery("#add_page_builder_item > .column").length;
    ...
    jQuery(document).on("click", ".uploadfile", function () {

<?php
	...
	?>
	<div class="element_size_<?php echo cs_allow_special_char($cs_node->var_pb_team_element_size);?>">
    	<?php if ($cs_node->var_pb_team_title <> '') { ?>
            <header class="cs-heading-title">
                <h2 class="cs-section-title"><?php echo cs_allow_special_char($cs_node->var_pb_team_title); ?></h2>
            </header>
        <?php  } 
            $args = array(
						'posts_per_page'			=> "-1",
					...
					$args = array(
						...
						if($cs_node->var_pb_team_view == 'listing'){
							...
							?>
                            <article class="<?php echo cs_allow_special_char($post_class);?>">
                                <figure>
                                ...
                                <div class="text">
                                        ...
                                        <div class="followus">
                                            <?php if($cs_xmlObject_team->facebook <> ''){?><a href="<?php echo cs_allow_special_char($cs_xmlObject_team->facebook);?>" target="_blank"><i class="fa fa-facebook-square"></i></a><?php }?>
                                            <?php if($cs_xmlObject_team->twitter <> ''){?><a href="<?php echo cs_allow_special_char($cs_xmlObject_team->twitter);?>" target="_blank"><i class="fa fa-twitter"></i></a><?php }?>
                                            <?php if($cs_xmlObject_team->linkedin <> ''){?><a href="<?php echo cs_allow_special_char($cs_xmlObject_team->linkedin);?>" target="_blank"><i class="fa fa-instagram"></i></a><?php }?>
                                            <?php if($cs_xmlObject_team->google_plus <> ''){?><a href="<?php echo cs_allow_special_char($cs_xmlObject_team->google_plus);?>" target="_blank"><i class="fa fa-google"></i></a><?php }?>

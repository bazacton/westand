...
?>
	<div class="element_size_<?php echo cs_allow_special_char($cs_node->slider_element_size); ?> column banner"> 
    <?php	if ($cs_node->slider_header_title <> '' && $cs_node->slider_view <> "header") { ?>
    	<header class="heading">
        	<h2 class="headding-color section-title"><?php echo cs_allow_special_char($cs_node->slider_header_title); ?></h2>
       	</header>
    <?php  } ?>
    <article>
 	<?php

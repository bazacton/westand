...
(function() {
	tinymce.create('tinymce.plugins.<?php echo cs_allow_special_char($shortcodesES->buttonName); ?>', {
		init : function(ed, url) {
		},	
		createControl : function(n, cm) {
			if(n=='<?php echo cs_allow_special_char($shortcodesES->buttonName); ?>'){
                var mlb = cm.createListBox('<?php echo cs_allow_special_char($shortcodesES->buttonName); ?>', {
                     title : 'Shortcode',
	...
	// Register plugin
	tinymce.PluginManager.add('<?php echo cs_allow_special_char($shortcodesES->buttonName); ?>', tinymce.plugins.<?php echo cs_allow_special_char($shortcodesES->buttonName); ?>);
})();

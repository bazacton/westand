<?php
	...
	function cs_cause_register() {
        ...
        cs_register_post_type( 'cs_cause' , $args );
		}
		...
		function cs_cause_categories() 
	{
		  ...
		  cs_register_taxonomy('cs_cause-category',array('cs_cause'), array(
			'hierarchical' => true,
			'labels' => $labels,
			'show_ui' => true,
			'query_var' => true,
...
if(function_exists('cs_register_taxonomy')){
		  cs_register_taxonomy('cs_cause-tag','cs_cause',array(
			'hierarchical' => false,
			'labels' => $labels,
			'show_ui' => true,
...
if(function_exists('cs_meta_boxes')) {
	cs_meta_boxes('cs_meta_menu_add');
}

		function cs_meta_menu_add()
		{  
		 if(function_exists('cs_meta_box')) {
			cs_meta_box( 'cs_meta_menu', 'Cause Options', 'cs_meta_menu', 'cs_cause', 'normal', 'high' );  
		 }
		}
...
<div class="clear"></div>
                    ...
                    <ul class="form-elements noborder">
                            ...
                            <li class="to-field">
                            	...
                            	<input type="text" id="cause_end_date" name="cause_end_date" value="<?php echo cs_allow_special_char($cause_end_date);?>" />

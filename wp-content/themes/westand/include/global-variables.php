...
$cs_theme_option['google_api_key']=isset($cs_theme_option['google_api_key']) ? $cs_theme_option['google_api_key']:'';
...
if ( ! defined('DEMO_DATA_URL') ) {
    define('DEMO_DATA_URL', 'http://chimpgroup.com/wp-demo/webservice/demo/westand/');
}
if ( ! defined('DEMO_DATA_IMG_URL') ) {
    define('DEMO_DATA_IMG_URL', 'http://chimpgroup.com/wp-demo/webservice/demo_images/westand/');
}
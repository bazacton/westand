			...
			if ( $cs_cause <> "" ) {
			  ...
			  if(strtotime($cause_end_date) < strtotime(date('m/d/Y'))){
				...
				if($cs_theme_option['trans_switcher'] == "on")
					{ 
						$cause_status = __('Closed','westand');
			        }
				    else
					{ 
			...
			?>
                        ...
                        <div class="<?php echo cs_allow_special_char($cs_layout); ?>">
                            ...
                            <div class="element_size_100">
                                <div class="causes causes-detail">
                                    <article class="detail-figure">
                                    	<?php if($image_url <> ""){?><figure><img src="<?php echo cs_allow_special_char($image_url);?>" alt="image_url"></figure><?php }?>
                                        <div class="bottom-cause">
                                            <div class="cause-left"><span class="cs-colr"><?php echo cs_allow_special_char($cs_theme_option['paypal_currency_sign']);?><?php echo number_format($payment_gross);?></span> <?php if($cs_theme_option['trans_switcher'] == "on"){ _e('Raised','westand');}else{ echo cs_allow_special_char($cs_theme_option['cause_raised']); }?></div>
                                            <div class="cause-right">
                                                <div class="progress-wrap">
                                                    <div class="progress-bar-charity" data-loadbar="<?php echo cs_allow_special_char(round($percentage_amount));?>" data-loadbar-text="<?php echo round($percentage_amount);?>%">
                                                        <div class="cs-bgcolr"></div>
                                                    </div>
                                                </div>
                                                <div class="progress-desc">
                                                    <span class="progress-box-left"> <?php if($cs_theme_option['trans_switcher'] == "on"){ $trans_featured = _e('Goal','westand');}else{ echo cs_allow_special_char($cs_theme_option['cause_goal']); }?> <?php echo cs_allow_special_char($cs_theme_option['paypal_currency_sign']);?><?php echo number_format((float)$cs_xmlObject->cause_goal_amount,2,",",".");?> </span>
                                             ...
                                             <?php if(isset($cause_status) && $cause_status <> ''){
                                                ...
                                                <a href="#" class="btn cs-btn-donate cs-bgcolrhvr" data-toggle="modal" data-target="#CausemyModal2<?php echo cs_allow_special_char($post->ID);?>"><?php if($cs_theme_option['trans_switcher'] == "on"){ $trans_featured = _e('Donate Now','westand');}else{ echo cs_allow_special_char($cs_theme_option['cause_donate']); }?></a>
                                             <?php }?>
                                            </div>
                                        </div>
                                         <?php 
                                    ...
                                    <div class="donar-table">
                                        ...
                                        <h2 class="cs-section-title"><?php if($cs_theme_option['trans_switcher'] == "on"){ $trans_featured = _e('Donors','westand');}else{ echo cs_allow_special_char($cs_theme_option['cause_donors']); }?></h2>
                                        ...
                                        <ul>
                                            ...
                                            <li><span class="counter"><?php echo cs_allow_special_char($cause_cout);?></span><a><?php echo cs_allow_special_char($transct->address_name);?></a><p><span><?php echo cs_allow_special_char($transct->payment_gross);?> <?php echo cs_allow_special_char($cs_theme_option['paypal_currency']);?></span><a><?php if($cs_theme_option['trans_switcher'] == "on"){ _e('Donation','westand');}else{ echo cs_allow_special_char($cs_theme_option['cause_donation']); }?></a></p></li>
                            ...
                            <div class="share-post">
								...
								?>
                                <a class="addthis_button_compact btnshare"><i class="fa fa-share-square-o"></i><?php if($cs_theme_option['trans_switcher'] == "on"){ _e('Sahre','westand');}else{ echo cs_allow_special_char($cs_theme_option['trans_share_this_post']); } ?> </a>
                                <?php
								}
								?>
                            ...
                            <?php if (isset($cs_xmlObject->post_author_info_show) && $cs_xmlObject->post_author_info_show == "on"){?>
                                ...
                                <div class="about-author">
                                    <figure><a href="<?php echo get_author_posts_url(get_the_author_meta('ID')); ?>"><?php echo cs_allow_special_char(get_avatar(get_the_author_meta('user_email'), apply_filters('PixFill_author_bio_avatar_size', 59))); ?></a></figure>
                                    <div class="text">
                                        <h4><?php echo cs_allow_special_char(get_the_author()); ?></h4>

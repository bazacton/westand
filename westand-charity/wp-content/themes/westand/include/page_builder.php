...
global $cs_theme_option;
		...
		if(function_exists('cs_meta_boxes')) {
	     cs_meta_boxes('cs_page_bulider_add');
		}
function cs_page_bulider_add() {
	if(function_exists('cs_meta_box')) {
	cs_meta_box( 'id_page_builder', 'Page Options', 'cs_page_bulider', 'page', 'normal', 'high' ); 
	}	
}  
...
?>
    <div class="page-wrap page-opts" style="overflow:hidden; position:relative; height: 705px;">
        ...
        <div id="add_page_builder_item">
            ...
            <img src="<?php echo get_template_directory_uri()?>/images/admin/bg-arrowup.png" alt="image_url" /></div>
        </div>

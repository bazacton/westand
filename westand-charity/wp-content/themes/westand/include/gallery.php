...
function cs_gallery_register() {
    ...
    if (function_exists('cs_register_post_type')) {
        cs_register_post_type('cs_gallery', $args);
    }
}
...
if (function_exists('cs_meta_boxes')) {
    cs_meta_boxes('cs_meta_gallery_add');
}

function cs_meta_gallery_add() {
    if (function_exists('cs_meta_box')) {
        cs_meta_box('cs_meta_gallery', 'Gallery Options', 'cs_meta_gallery', 'cs_gallery', 'normal', 'high');
    }
}
                ...
                <div class="to-social-network">
                    <div class="gal-active">
                        ...
                        <div class="dragareamain">
                            <div class="placehoder">Gallery is Empty. Please Select Media <img src="<?php echo get_template_directory_uri() ?>/images/admin/bg-arrowdown.png" alt="image_url" /></div>
                            <ul id="gal-sortable">
                                <?php
                    ...
                    <div class="to-social-list">
                        ...
                        <script>
                            ...
                            var counter = 0;
                            var count_items = <?php echo cs_allow_special_char($cs_counter_gal) ?>;
                            if (count_items > 0) {

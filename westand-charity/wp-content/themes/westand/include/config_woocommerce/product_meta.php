...
cs_meta_boxes('cs_meta_woo_prod_add');
 }
function cs_meta_woo_prod_add()
{  
 if(function_exists('cs_meta_box')) {
	cs_meta_box( 'cs_meta_woo_prod', 'Product Layout Options', 'cs_meta_woo_prod', 'product', 'normal', 'low' );  
 }
}
        ...
        <div class="option-sec row">
            <div class="opt-conts">
            	<ul class="form-elements" style="display:none;">
                    ...
                    <li class="to-field">
                    	<input type="text" name="sub_title" value="<?php echo cs_allow_special_char($sub_title); ?>" />

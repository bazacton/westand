	  ...
	  <?php
		...
		<div id="wrappermain-cs" class="wrapper <?php echo cs_wrapper_class().$main_wrapper_class;?>">
			<?php
                ...
                <style>
					.breadcrumbs ul li {
						background-color:<?php echo cs_allow_special_char($page_subheader_color);?>;
					}
				</style>
                
                <div class="breadcrumb" <?php if(isset($header_banner_image) && $header_banner_image <> ''){?>style=" background: url('<?php echo cs_allow_special_char($header_banner_image);?>') no-repeat scroll center bottom / cover  <?php echo cs_allow_special_char($page_subheader_color);?>"<?php } else {?>style="background-color:<?php echo cs_allow_special_char($page_subheader_color);?>;"<?php }?>>
                	<div class="container">
                ...
                <?php } else if(isset($header_banner_style) && $header_banner_style == 'flex_slider'){
                		...
                		if(isset($custom_slider_id) && $custom_slider_id <> ''){
							echo do_shortcode(wp_specialchars_decode($custom_slider_id));	
						} else {
